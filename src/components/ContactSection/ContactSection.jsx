...
function ContactSection() {
  return (
    <motion.section
      ...
      animate="animate"
    >
      <motion.div className={styles.contactWrapper} variants={itemVariants}>
        {/* Contact Methods */}
        <div className={styles.contactMethods}>
          ...
          >
            ...
            <span className={styles.linkText}>{CONTACT_INFO.whatsapp.number}</span>
          </motion.a>
          ...
          >
            ...
            <span className={styles.linkText}>{CONTACT_INFO.phone.number}</span>
          </motion.a>
        </div>
